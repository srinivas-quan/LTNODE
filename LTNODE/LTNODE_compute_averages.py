...
Savedir = args.savedir#results_new1
rot = 45
attack = 'FGSM'
...
for ID in range(5):
	...
	#######Robustness##################
	Entropy_count.append(np.load(savedir+'/_'+attack+'_entropy_count_TUNODE.npy'))
	Confidence_count.append( np.load(savedir+'/_'+attack+'_confidence_count_TUNODE.npy'))
	Error.append( np.load(savedir+'/_'+attack+'_Error_TUNODE.npy'))
	Accuracy.append(1.0 - np.load(savedir+'/_'+attack+'_Error_TUNODE.npy'))
	#Prob_vec .append( np.load(savedir+'/_'+attack+'_Prob_vec_TUNODE.npy')
	
	#########OOD###############3
	target_entropy_count.append( np.load(savedir+'/_ood_entropy_count_TUNODE.npy'))
	target_confidence_count.append( np.load(savedir+'/_ood_confidence_count_TUNODE.npy'))
	err_props.append( np.load(savedir+'/_err_props_TUNODE.npy') )
	Accuracy_props.append(1.0 - np.load(savedir+'/_err_props_TUNODE.npy') )
	...
	#########rotation   #####333
	conf_count.append( np.load(savedir+'/_conf_count_TUNODE%d.npy'%(rot)))#rejection plot
	acc_count.append( np.load(savedir+'/_acc_count_TUNODE%d.npy'%(rot)))
	results.append( np.load(savedir+'/_results_TUNODE.npy'))
...
np.save(Savedir+'/_'+dataset+'_'+attack+'_entropy_count_TUNODE.npy',Entropy_count_ms)
np.save(Savedir+'/_'+dataset+'_'+attack+'_confidence_count_TUNODE.npy',Confidence_count_ms)
np.save(Savedir+'/_'+dataset+'_'+attack+'_Error_TUNODE.npy',Error_ms)
#np.save(savedir+'/_'+attack+'_Prob_vec_TUNODE.npy',Prob_vec)
#print(Error_ms)
#print(Error)

np.save(Savedir+'/'+dataset+'_ood_entropy_count_TUNODE.npy',target_entropy_count_ms)
np.save(Savedir+'/'+dataset+'_ood_confidence_count_TUNODE.npy',target_confidence_count_ms)
np.save(Savedir+'/'+dataset+'_err_props_TUNODE.npy',err_props_ms)
np.save(Savedir+'/'+dataset+'_acc_props_TUNODE.npy',Accuracy_props_ms)

np.save(Savedir+'/'+dataset+'_conf_count_TUNODE%d.npy'%(rot),conf_count_ms)
np.save(Savedir+'/'+dataset+'_acc_count_TUNODE%d.npy'%(rot),acc_count_ms)
np.save(Savedir+'/'+dataset+'_results_TUNODE.npy',results_ms)
